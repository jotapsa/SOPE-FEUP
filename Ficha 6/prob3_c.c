...
int main()
{
  ...
  /*Quando termina mos a main thread ela tambem termina o processo associado, matando assim todas as
  threads que demos spawn. Como esta descrito na man page do linux
